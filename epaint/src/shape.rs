...
pub struct CallbackShape {
    ...
    ///
    /// The first argument is the render context, and what it contains depends on the backend.
...
impl std::fmt::Debug for CallbackShape {
...
impl std::cmp::PartialEq for CallbackShape {
...
impl From<CallbackShape> for Shape {
    #[inline(always)]
    fn from(shape: CallbackShape) -> Self {
        Self::Callback(shape)
    }
}
